...
import com.example.lastcal.adapter.MenuListAdapter
import com.example.lastcal.models.Menus
import com.example.lastcal.models.RestaurentModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        checkoutButton.setOnClickListener{
            if(itemsInTheCartList != null && itemsInTheCartList!!.size <= 0){
                Toast.makeText(this@RestaurantMenuActivity, "Please add items in cart",Toast.LENGTH_LONG).show()
            }
            else{
